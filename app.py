...
with container2:
    ...
    st.markdown("[Data source](https://docs.google.com/spreadsheets/d/1V6ucyFGKWuSQzvI8lMzvvWJHrBS82echMVJH37kwgjE/edit?usp=sharing) - All tests conducted by [Bjørn Nyland](https://www.youtube.com/user/bjornnyland)")